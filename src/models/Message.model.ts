...
export const createMessage = async ({ conversation, createdByUser, body }: CreateMessageParams) => {
  const m = await MessageModel.create(
    { conversationId: conversation.id, createdByUserId: createdByUser.id, body },
